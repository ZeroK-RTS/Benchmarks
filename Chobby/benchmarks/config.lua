...
local data = {
	{
		humanName = "BAR benchmark",
		name = "BenchmarkBAR",
		decription = "Compare BAR to 1544.",
		map = "Comet Catcher Redux v3.1",
		game = "Zero-K v1.10.1.3",
		gameList = {"Zero-K v1.10.1.3"},
		duplicates = 10,
		...
		runs = {
			{
				file = "20220121_221627_Comet Catcher Redux v3_104.0.1-1544-ge1f249f maintenance.sdfz",
				engine = "104.0.1-1544-ge1f249f",
				settings = settings,
				runName = "Engine 1544",
			},
			{
				file = "20220121_111422_Comet Catcher Redux v3_105.1.1-798-gae7f0f8 BAR105",
				engine = "105.1.1-798-gae7f0f8",
				settings = settings,
				runName = "Engine 798",
			},
		}
